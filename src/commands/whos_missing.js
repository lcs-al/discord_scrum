...
module.exports = {
  ...
  async execute(interaction) {
    ...
    var in_channel_members_list = current_voice_channel.members.map(
      (member) => {
    ...
    var missing_message =
      "The following users still not connected to the daily meeting: " +
      "\u200b";
    var missing_list = [];
    ...
    var message_content =
      missing_list.length > 0 ? missing_message : attendance_message;
